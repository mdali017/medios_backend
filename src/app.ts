...
import * as googleSheetsController from './modules/google-sheets/google-sheets.controller'
...
app.get('/api/v1/admin/google-sheets/callback', googleSheetsController.oauthCallback)
