...
router.post('/register', (0, validate_1.validateBody)(auth_validation_1.registerSchema), authController.register);
router.post('/login', (0, validate_1.validateBody)(auth_validation_1.loginSchema), authController.login);
router.post('/refresh-token', (0, validate_1.validateBody)(auth_validation_1.refreshTokenSchema), authController.refreshToken);
